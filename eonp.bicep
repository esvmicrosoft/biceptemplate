...
var machines = [
  { publisher: 'suse', offer: 'manager-server-5-0-byos',          sku: 'gen2',               version: 'latest' } 
]
...
resource vm 'Microsoft.Compute/virtualMachines@2023-09-01' = [for i in range(0,length(machines)): {
  ...
  properties: {
    ...
    osProfile: {
      ...
      customData: 'I2Nsb3VkLWNvbmZpZwoKcnVuY21kOgotIHNlZCAtaWUgJ3MvRXh0ZW5zaW9ucy5FbmFibGVkPS4qL0V4dGVuc2lvbnMuRW5hYmxlZD15LycgL2V0Yy93YWFnZW50LmNvbmYKLSBzeXN0ZW1jdGwgcmVzdGFydCB3YWFnZW50LnNlcnZpY2UK'
    }
