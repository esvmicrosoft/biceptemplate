...
var machines = [
  { name: 'rhel810',   vmsize: 'Standard_D2ads_v6',  imageid: {publisher: 'redhat',    offer: 'rhel',             sku: '810-gen2',    version: 'latest'  }}
  { name: 'rhel97',    vmsize: 'Standard_D2ads_v6',  imageid: {publisher: 'redhat',    offer: 'rhel',             sku: '97-gen2',     version: 'latest'  }}
  { name: 'rhel10',    vmsize: 'Standard_D2ads_v6',  imageid: {publisher: 'redhat',    offer: 'rhel',             sku: '10-lvm-gen2', version: 'latest'  }}
  { name: 'ubu24lts',  vmsize: 'Standard_D2ads_v6',  imageid: {publisher: 'canonical', offer: 'ubuntu-24_04-lts', sku: 'server',      version: 'latest'  }}
